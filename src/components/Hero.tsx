  ...
  return (
    <section className='max-container padding-container flex flex-col
      ...
      <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
        ...
        />
        <h1 className='bold-52 lg:bold-88 xl:max-w-[600px]'>Putuk Turno Camp Area</h1>
        ...
        <div className='my-11 flex flex-wrap gap-5'>
          <div className='flex items-center gap-2'>
            ...
            <p className='bold-16 lg:bold-20 text-blue-400'> 198k
              <span className='regular-16 
                  lg:regular-20 ml-1'>Excellent Reviews</span>
            </p>
